        ...
        <div className="w-[80%] mx-auto">
          ...
          <div className="bg-green-50 p-6 rounded-2xl border border-green-200 text-center">
            ...
            <p className="text-green-700 mb-4 text-sm">
              Our support team is online and ready to help you schedule.
            </p>
            <a
              href="https://wa.me/1234567890"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white px-6 py-3 rounded-full font-semibold hover:bg-green-600 transition shadow-lg hover:shadow-xl w-full"
            >

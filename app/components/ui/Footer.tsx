...
export default function Footer() {
  return (
    <footer className="bg-[#000a57] text-[#F8FAFC] pt-16 pb-8 font-[family-name:var(--font-poppins)] relative border-t-4 border-[#002874]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.name}>
                  <Link href={link.path} className="text-gray-300 hover:text-[#002874] transition-colors flex items-center gap-2 before:content-[''] before:w-1.5 before:h-1.5 before:bg-[#002874] before:rounded-full">
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={course}>
                  <Link href="/courses" className="text-gray-300 hover:text-[#002874] transition-colors flex items-center gap-2 before:content-[''] before:w-1.5 before:h-1.5 before:bg-[#002874] before:rounded-full">
                    {course}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                <Clock className="w-5 h-5 text-[#002874] mt-1 flex-shrink-0" />
                <div>
              ...
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-[#002874] mt-1 flex-shrink-0" />
                <div>
